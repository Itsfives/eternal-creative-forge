  ...
  const services = [
    {
      ...
      color: "text-light-beige-gold",
      bgColor: "bg-light-beige-gold/10",
      borderColor: "border-light-beige-gold/20",
      hoverShadow: "hover:shadow-light-beige-gold/20"
    },
    {
      icon: Palette,
      title: "Graphic Design",
      description: "Stunning visual identities, branding, logos, and marketing materials that captivate audiences.",
      color: "text-sea-serpent-blue",
      bgColor: "bg-sea-serpent-blue/10",
      borderColor: "border-sea-serpent-blue/20",
      hoverShadow: "hover:shadow-sea-serpent-blue/20"
    },
    {
      icon: Box,
      title: "3D Modeling",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className={`text-center mb-16 transition-all duration-1000 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            <span className="bg-gradient-to-r from-light-beige-gold to-sea-serpent-blue bg-clip-text text-transparent">
              Our Services
            </span>
          </h2>
        ...
        <div ref={ctaRef} className={`text-center mt-16 transition-all duration-1000 ${ctaVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-flex items-center justify-center w-full max-w-md mx-auto p-1 bg-gradient-to-r from-light-beige-gold to-sea-serpent-blue rounded-full hover:scale-105 transition-transform duration-300 hover:shadow-lg hover:shadow-light-beige-gold/25">
            <div className="bg-background rounded-full px-8 py-4 w-full text-center hover:bg-background/90 transition-colors duration-300">
              <p className="text-foreground font-semibold">
                ...
                <span className="bg-gradient-to-r from-light-beige-gold to-sea-serpent-blue bg-clip-text text-transparent cursor-pointer hover:underline hover:scale-105 inline-block transition-all duration-300">
                  Let's talk!
                </span>
              </p>
            </div>
